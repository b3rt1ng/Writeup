...
### Main Page: mcp.kobold.htb

Browsing `https://kobold.htb` reveals a direct link to `mcp.kobold.htb` (MCPJam Inspector).
...
Interface: **Arcane v1.13.0**, a Docker manager with access to the `unix:///var/run/docker.sock` socket.
